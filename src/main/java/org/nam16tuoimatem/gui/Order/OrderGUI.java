...
public class OrderGUI extends javax.swing.JPanel {
    ...
    private void initComboboxCustomers() {
        ...
        cbCustomer.addItem(new Item(null, "### CUSTOMER ID NAME ###"));

        CustomerService.getInstance().findAll().forEach(instructor
                -> cbCustomer.addItem(new Item(instructor.getCustomerId(),
                        "" + instructor.getCustomerId() + " - " + instructor.getFullname())));
    }
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        if (!txtVegetableNameSearch.getText().equals("")) {
            search.add(new SearchMap("vegetableName", txtVegetableNameSearch.getText()));
        }
    ...
    private void btnCheckOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckOutActionPerformed
        ...
        int customerId = ((Item) cbCustomer.getSelectedItem()).getId();
        ...
        orderList.stream().forEach(item -> {
            ...
            orderdetail.setVegetableId(item.vegetableId());
            orderdetail.setQuantity(item.count());
            orderdetail.setPrice(item.total());
    ...
    private javax.swing.JComboBox<Item> cbCustomer;
